...
#define FLP_LORA_RX_TASK_PRIORITY  20  // Timing-critical; must drain FIFO before next RX
#define FLP_MESH_TASK_PRIORITY     15  // Core routing, must not stall during transfer
