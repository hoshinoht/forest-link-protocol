 ...
 *
 * With 1 MB cache and a typical 524 KB demo file, the entire file
 * is resident in PSRAM after open() — transfer reads never touch SD.
 */
class SdReadCache
{
  public:
    static constexpr size_t MAX_CACHE_SIZE = 1024 * 1024; /* 1 MB cap */
